...
alias gpt1='gpt -i'
alias gptti='gpt -c italian_translations -i'
alias gpttf='gpt -c french_translations -i'
alias gpttwi='cd $cst; gpt -c italian_translations -f wordsi.out'
alias gpttwf='cd $cst; gpt -c french_translations -f wordsf.out'
...
alias viw='cd $cst; vi wordsi.out'
alias vig='cd $cst; vi griti.out'
...
alias vitae='cd $cst; vi italian_american_expressions.txt'
...
alias it='cd $cst;  ./run.py italian_basic,italian_advanced,italian_expressions,italian_american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters -q 0 -ps 1 -cat ""'
alias grit='cd $cst; ./grit.py -l 1 -subjects italian_basic,italian_advanced,italian_expressions,italian_american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters' 
alias gwi='cd $cst; grit_words.py -subjects italian_basic,italian_advanced,italian_expressions,italian_american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters -file wordsi.out -one_per_line 1 >& griti.out; vi griti.out'
alias fdit='cd $cst; ./find_dups.py italian_basic,italian_advanced,italian_expressions,italian_american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters'
alias sayi='say -v Alice -r 120'

alias vfw='cd $cst; vi wordsf.out'
alias vfg='cd $cst; vi gritf.out'
alias vftb='cd $cst; vi french_basic.txt'
alias vfta='cd $cst; vi french_advanced.txt'
alias vfte='cd $cst; vi french_expressions.txt'
alias vftae='cd $cst; vi french_american_expressions.txt'
alias vftv='cd $cst; vi french_vulgar.txt'
...
alias ft='cd $cst;  ./run.py french_basic,french_advanced,french_expressions,french_american_expressions,french_vulgar -q 0 -ps 1 -cat ""'
alias grft='cd $cst; ./grit.py -l 1 -subjects french_basic,french_advanced,french_expressions,french_american_expressions,french_vulgar' 
alias gwf='cd $cst; grit_words.py -subjects french_basic,french_advanced,french_expressions,french_american_expressions,french_vulgar -file wordsf.out -one_per_line 1 >& gritf.out; vi gritf.out'
alias fdft='cd $cst; ./find_dups.py french_basic,french_advanced,french_expressions,french_american_expressions,french_vulgar'
