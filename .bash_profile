...
alias gritt='cd $cst; ./grit.py -l italian -v Alice -s 1 -lu 1 -subjects $it_s'
...
alias grft='cd $cst; ./grit.py -l french -v Thomas -s 0 -lu 1 -subjects $fr_s'
alias grftt='cd $cst; ./grit.py -l french -v Thomas -s 1 -lu 1 -subjects $fr_s'
...
alias sft='cd $cst; ./talk.py -subjects $fr_s -v Thomas'
