...
alias grit='cd $cst; ./grit.py -l 1 -subjects italian_basic,italian_advanced,italian_expressions,american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters' 
alias gwi='cd $cst; grit_words.py -subjects italian_basic,italian_advanced,italian_expressions,american_expressions,italian_vulgar,italian_passato_remoto,italian_tongue_twisters -file wordsi.out -one_per_line 1 >& griti.out; vi griti.out'
...
alias vftae='cd $cst; vi american_expressions.txt'
...
alias ftae='cd $cst; ./run.py american_expressions -q 0 -ps 2 -cat ""'
alias fte='cd $cst; ./run.py french_expressions -q 0 -ps 4 -cat ""'
alias ftv='cd $cst; ./run.py french_vulgar -q 0 -ps 4 -cat ""'
alias ft='cd $cst;  ./run.py french_basic,french_advanced,french_expressions,american_expressions,french_vulgar -q 0 -ps 1 -cat ""'
alias grft='cd $cst; ./grit.py -l 1 -subjects french_basic,french_advanced,french_expressions,american_expressions,french_vulgar' 
alias gwf='cd $cst; grit_words.py -subjects french_basic,french_advanced,french_expressions,american_expressions,french_vulgar -file wordsf.out -one_per_line 1 >& gritf.out; vi gritf.out'
alias fdft='cd $cst; ./find_dups.py french_basic,french_advanced,french_expressions,american_expressions,french_vulgar'
